<template>
    <div class="form-label-group-select overflow-hidden"
         :class="{'chosen': value !== '' && value != null}">
        <label>
            {{$t('userPhoneCountryCode')}}
        </label>
        <select class="form-control"
            ...
            <option value=""></option>
            <option :value="defaultCountryCode.value">
                {{defaultCountryCode.name}}
            </option>
            <optgroup :label="$t('anotherCountries')">
                <option  v-for="(option, index) in countryCodes"
                         :value="option.value"
                         :key="index"
                >
                    {{option.name}}
  ...
  data() {
    return {
      ...
      countryCodes: [
        ...
        { name: 'American Samoa (+1684)', value: 1684 },
        ...
        { name: 'British Virgin Islands (+1284)', value: 1284 },
        ...
        { name: 'Cocos Islands (+61)', value: 61 },
        ...
        { name: 'North Korea (+850)', value: 850 },
        ...
        { name: 'Saint Helena (+290)', value: 290 },
        ...
        { name: 'Sint Maarten (+1721)', value: 1721 },
        ...
        { name: 'U.S. Virgin Islands (+1340)', value: 1340 },
